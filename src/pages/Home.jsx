    ...
    <section className="relative h-screen min-h-[640px] overflow-hidden flex items-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 pt-20">
        {loaded && (
          <>
            ...
            >
              Apna<br />
              <span className="italic text-gold-300">Studio</span>
            </motion.h1>
      ...
      <div className="absolute right-6 bottom-1/3 z-20 hidden lg:flex flex-col items-center gap-4">
        ...
        <a href={siteConfig.social.instagram} target="_blank" rel="noreferrer"
          className="text-ink-400 hover:text-gold-400 transition-colors"><Instagram size={16} /></a>
        <a href={siteConfig.social.facebook} target="_blank" rel="noreferrer"
          className="text-ink-400 hover:text-gold-400 transition-colors"><Facebook size={16} /></a>
        <a href={`https://wa.me/${siteConfig.whatsapp}`} target="_blank" rel="noreferrer"
          className="text-ink-400 hover:text-gold-400 transition-colors"><MessageCircle size={16} /></a>
        <div className="w-px h-16 bg-ink-600" />
      </div>
    </section>
  )
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((svc, i) => (
            ...
            >
              ...
              <div className={`absolute -top-12 -right-12 w-40 h-40 rounded-full bg-gradient-to-br ${svc.accent} opacity-0 group-hover:opacity-10 blur-2xl transition-opacity duration-500`} />

              <div className={`inline-flex w-12 h-12 rounded-xl bg-gradient-to-br ${svc.accent} items-center justify-center text-2xl mb-5 shadow-lg`}>
                {svc.icon}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="font-display text-lg italic text-ink-200 leading-relaxed">
                "{t.quote}"
              </p>
              <div className="flex items-center gap-3 pt-1">
                <div className={`w-10 h-10 rounded-full ${t.avatarBg} flex items-center justify-center text-xs font-bold flex-shrink-0`}>
                  {t.avatar}
                </div>
                <div>
